...
const navItems = [
  ...
  { to: "/entities", label: "Entities", icon: NetworkIcon },
...
export default function Layout({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-screen overflow-hidden">
      {/* Sidebar */}
      <aside className="w-64 flex-shrink-0 bg-ink-950 text-ink-200 flex flex-col">
        {/* Logo */}
        <div className="px-6 py-5 border-b border-ink-800">
          <h1 className="text-xl font-serif font-bold text-white tracking-tight">
            News<span className="text-accent-400">Lens</span>
          </h1>
          <p className="text-xs text-ink-400 mt-0.5">AI-Powered News Intelligence</p>
        </div>
